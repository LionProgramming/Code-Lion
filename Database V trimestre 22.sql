...
CREATE TABLE IF NOT EXISTS `mydb`.`Usuario` (
  ...
  INDEX `fk_Usuario_TipoDocumento_idx` (`Tipo_idTipoDocumento` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Grado` (
  ...
  INDEX `fk_Grado_Usuario1_idx` (`director` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Observacion` (
  ...
  INDEX `fk_Observacion_Usuario1_idx` (`Usuario_documento` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Horario` (
  ...
  INDEX `fk_Horario_Grado1_idx` (`numero` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Matricula` (
  ...
  INDEX `fk_Usuario_has_Grado_Grado1_idx` (`Grado_numero` ASC) VISIBLE,
  INDEX `fk_Usuario_has_Grado_Usuario1_idx` (`Usuario_documento` ASC) VISIBLE,
